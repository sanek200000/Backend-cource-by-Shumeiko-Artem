...
class RoomsRepository(BaseRepository):
    ...
    async def get_filtred_by_time(self, hotel_id, data_from, data_to):
        """
        with rooms_count as (
        ...
        rooms_count = (
            ...
            .filter(BookingsOrm.date_from <= data_to, BookingsOrm.date_to >= data_from)
        ...
        return await self.get_filtred(RoomsOrm.id.in_(query))
